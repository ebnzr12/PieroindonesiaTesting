...
@Then("^click cara pengembalian$")
public void click_cara_pengembalian() throws Throwable{
	driver.findElement(By.xpath("/html/body/div[1]/footer/div/div[1]/div/div[2]/ul/li[3]/a")).click();
}
}
