...
@Then("^click tentang kami")
public void click_tentang_kami() throws Throwable{
	driver.findElement(By.xpath("/html/body/div[1]/footer/div/div[1]/div/div[1]/ul/li[1]/a")).click();
